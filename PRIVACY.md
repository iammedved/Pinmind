...
Pinmind `0.6.3` is a skills-only plugin. It provides local instructions, a bundled kernel, and offline AEP and language-routing evaluation corpora; it has no account system, connector, MCP server, telemetry service, or project-operated network endpoint.
