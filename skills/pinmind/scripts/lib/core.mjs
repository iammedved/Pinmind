...
export function routeTask(input = {}) {
  ...
  const requestedChange = implementDirective || colloquialMutate || productDesire || evalHarness || (!metaEvaluation && !leadingReadOnly && !opinionBlocksChange && (((changeMention && (!planningRequest || planningAndExecution)) || mutateParaphrase) && !inspectParaphrase && !diagnoseParaphrase));
